#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/ibruzg/ProxmoxVE-frigate/main/misc/build.func)
...
ADDON_SCRIPT="https://raw.githubusercontent.com/ibruzg/ProxmoxVE-frigate/main/tools/addon/dokploy.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/ibruzg/ProxmoxVE-frigate/main/tools/addon/dokploy.sh)"
MIGRATION_EOF
