...
ADDON_SCRIPT="https://raw.githubusercontent.com/ibruzg/ProxmoxVE-frigate/main/tools/addon/komodo.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/ibruzg/ProxmoxVE-frigate/main/tools/addon/komodo.sh)"
MIGRATION_EOF
